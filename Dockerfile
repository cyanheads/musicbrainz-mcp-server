...
ARG APP_VERSION
LABEL org.opencontainers.image.title="musicbrainz-mcp-server"
LABEL org.opencontainers.image.description="Search artists, releases, recordings, works, and labels; traverse relationships; resolve ISRC/ISWC/barcode; fetch cover art via MCP. STDIO or Streamable HTTP."
LABEL org.opencontainers.image.licenses="Apache-2.0"
LABEL org.opencontainers.image.version="${APP_VERSION}"
LABEL org.opencontainers.image.source="https://github.com/cyanheads/musicbrainz-mcp-server"
...
# imports directly remains in its own dependencies.
RUN --mount=type=cache,target=/root/.bun/install/cache \
...
RUN mkdir -p /var/log/musicbrainz-mcp-server && chown -R bun:bun /var/log/musicbrainz-mcp-server
...
ENV LOGS_DIR="/var/log/musicbrainz-mcp-server"
